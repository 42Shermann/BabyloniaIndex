const DATA =  [
  
    {
        ...
        chibiImg:{
            awaken:
            "https://drive.google.com/uc?export=download&id=1W-vGMLEQcm-UuLetNRj3PA9kSQbUeT61"
            ,dorm:
            "https://drive.google.com/uc?export=download&id=1ThH7AL5hUBHZAkBlfAycJQl35R_zTh-g"
        },
        Speciality:[
            "Duel - Has strong single attack ability.",
            "Form Switch - Skills can switch attacking modes."
        ],
        element:[
            {
                eleType:
