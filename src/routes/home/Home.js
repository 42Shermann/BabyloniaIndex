...
function Home() {
    return (
        <div>
            ...
            <p className='text-white lead'>This site was built with the purpose of creating a aggregate of information for the Global version of Punishing: Gray Raven. Information from other versions of the game is also present here so that Global players can have a certain amount of foresight, but egregious spoilers from future patches will not be included.</p>
